...
/* ---------------------------------------------------------------------------
 */
static __inline const uint8_t *find_start_code(const uint8_t *data, int len) {
...
/* ---------------------------------------------------------------------------
 */
static int check_frame(const uint8_t *data, int len) {
  const uint8_t *p;
...
/* ---------------------------------------------------------------------------
 */
static int find_one_frame(uint8_t *data, int len, int *start, int *end) {
...
/* ---------------------------------------------------------------------------
 */
static int count_frames(uint8_t *data, int size) {
  int count = 0;
  int start, end;
...
/* ---------------------------------------------------------------------------
 */
static int read_input_file(davs2_input_param_t *p_param, uint8_t **data,
                           int *size, int *frames, float errrate) {
