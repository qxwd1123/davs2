...
void deblock_edge_ver_avx2(pel_t *SrcPtr, int stride, int Alpha, int Beta,
  ...
  TRL0 = _mm256_inserti128_si256(_mm256_castsi128_si256(TR0),
  _mm256_castsi256_si128(TLR0), 1); TRL1 =
  _mm256_inserti128_si256(_mm256_castsi128_si256(TR1),
  _mm256_castsi256_si128(TLR1), 1);
  */
  ...
  FLT = _mm_add_epi16(_mm256_castsi256_si128(FLT_LR),
                      _mm256_extracti128_si256(FLT_LR, 0x01));

  T0_256 = _mm256_cmpeq_epi16(TLR1, TLR0);
  M1 = _mm_and_si128(_mm256_castsi256_si128(T0_256),
                     _mm256_extracti128_si256(T0_256, 0x01));
  ...
  FS4 = _mm_blendv_epi8(_mm256_castsi256_si128(c_1_256),
                        _mm256_castsi256_si128(c_2_256),
                        _mm_cmpeq_epi16(_mm256_castsi256_si128(FLT_LR),
                                        _mm256_castsi256_si128(c_2_256)));
  FS3 = _mm_blendv_epi8(c0, _mm256_castsi256_si128(c_1_256),
                        _mm_cmpgt_epi16(BETA, T2));

  FS = _mm_blendv_epi8(c0, FS56,
                       _mm_cmpgt_epi16(FLT, _mm256_castsi256_si128(c_4_256)));
  FS = _mm_blendv_epi8(FS, FS4,
                       _mm_cmpeq_epi16(FLT, _mm256_castsi256_si128(c_4_256)));
  FS = _mm_blendv_epi8(FS, FS3,
                       _mm_cmpeq_epi16(FLT, _mm256_castsi256_si128(c_3_256)));
  ...
  TLR1w = TLR1;
  /* fs == 1 */
  T2 = _mm_add_epi16(_mm_add_epi16(TL0, TR0),
                     _mm256_castsi256_si128(c_2_256));  // L0 + R0 + 2
  T2_256 = _mm256_castsi128_si256(T2);
  T2_256 = _mm256_inserti128_si256(T2_256, T2, 1);  // save
  T1_256 = _mm256_srli_epi16(
      _mm256_add_epi16(_mm256_slli_epi16(TLR0, 1), T2_256), 2);
  TLR0w = _mm256_blendv_epi8(TLR0, T1_256, _mm256_cmpeq_epi16(FS_256, c_1_256));

  /* fs == 2 */
  T2_256 = _mm256_slli_epi16(T2_256, 1);
  T0_256 = _mm256_add_epi16(_mm256_slli_epi16(TLR1, 1),
                            _mm256_add_epi16(TLR1, TRL0));
  T0_256 = _mm256_add_epi16(_mm256_slli_epi16(TLR0, 3),
                            _mm256_add_epi16(T0_256, T2_256));
  T1_256 = _mm256_srli_epi16(_mm256_add_epi16(T0_256, c_4_256), 4);
  TLR0w =
      _mm256_blendv_epi8(TLR0w, T1_256, _mm256_cmpeq_epi16(FS_256, c_2_256));

  /* fs == 3 */
  T2_256 = _mm256_slli_epi16(T2_256, 1);  // (L0 << 2) + (R0 << 2) + 8
  T0_256 = _mm256_add_epi16(_mm256_slli_epi16(TLR1, 2),
                            _mm256_add_epi16(TLR2, TRL1));
  T0_256 = _mm256_add_epi16(_mm256_slli_epi16(TLR0, 1),
                            _mm256_add_epi16(T0_256, T2_256));
  T1_256 = _mm256_srli_epi16(T0_256, 4);
  TLR0w =
      _mm256_blendv_epi8(TLR0w, T1_256, _mm256_cmpeq_epi16(FS_256, c_3_256));

  T0_256 = _mm256_add_epi16(_mm256_add_epi16(TLR2, TRL0),
                            _mm256_slli_epi16(TLR2, 1));
  ...
  TLR1w =
      _mm256_blendv_epi8(TLR1w, T1_256, _mm256_cmpeq_epi16(FS_256, c_3_256));
  ...
  if (_mm_extract_epi64(FS, 0) || _mm_extract_epi64(FS, 1)) { /* fs == 4 */
    ...
    /* cal L0/R0 */
    T0_256 = _mm256_slli_epi16(
        _mm256_add_epi16(_mm256_add_epi16(TLR0, TLR2), TRL0), 3);
    T0_256 = _mm256_add_epi16(_mm256_add_epi16(T0_256, c_16_256),
                              _mm256_add_epi16(TLR0, TLR2));
    T2_256 = _mm256_add_epi16(_mm256_slli_epi16(TRL2, 1),
                              _mm256_slli_epi16(TRL2, 2));
    ...
    T0_256 = _mm256_add_epi16(
        T0_256, _mm256_sub_epi16(_mm256_slli_epi16(TLR0, 3), TLR0));
    T2_256 = _mm256_add_epi16(_mm256_slli_epi16(TLR2, 2),
                              _mm256_add_epi16(TRL0, c_8_256));
    ...
    T1_256 = _mm256_srli_epi16(
        _mm256_add_epi16(T0_256, _mm256_add_epi16(T2_256, c_4_256)), 3);
  ...
  T5 = _mm_packus_epi16(_mm256_castsi256_si128(TLR2),
                        _mm256_extracti128_si256(TLR1w, 0x01));
  T6 = _mm_packus_epi16(_mm256_castsi256_si128(TLR1w),
                        _mm256_extracti128_si256(TLR2, 0x01));
...
void deblock_edge_ver_c_avx2(pel_t *SrcPtrU, pel_t *SrcPtrV, int stride,
  ...
  T0 = _mm_abs_epi16(_mm_subs_epi16(_mm256_castsi256_si128(TLR0),
                                    _mm256_castsi256_si128(TRL0)));
  T1 = _mm_cmpgt_epi16(T0, _mm256_castsi256_si128(c_1_256));
  T2 = _mm_cmpgt_epi16(ALPHA, T0);
  ...
  FLT = _mm_add_epi16(_mm256_castsi256_si128(FLT_X),
                      _mm256_extracti128_si256(FLT_X, 0x01));
  ...
  FS56 = _mm_blendv_epi8(T1, T0, M1);
  FS4 = _mm_blendv_epi8(c0, _mm256_castsi256_si128(c_1_256),
                        _mm_cmpeq_epi16(_mm256_castsi256_si128(FLT_X),
                                        _mm256_castsi256_si128(c_2_256)));
  ...
  /* fs == 1 */
  T2 = _mm_add_epi16(
      _mm_add_epi16(_mm256_castsi256_si128(TLR0), _mm256_castsi256_si128(TRL0)),
      _mm256_castsi256_si128(c_2_256));  // L0 + R0 + 2
  T2_256 = _mm256_castsi128_si256(T2);
  T2_256 = _mm256_inserti128_si256(T2_256, T2, 1);  // save
  T1_256 = _mm256_srli_epi16(
...
void deblock_edge_hor_avx2(pel_t *SrcPtr, int stride, int Alpha, int Beta,
  ...
  if (_mm_extract_epi64(FS, 0) || _mm_extract_epi64(FS, 1)) { /* fs == 4 */
    ...
    _mm_storel_epi64((__m128i *)(SrcPtr - 0),
                     _mm256_extracti128_si256(TLR0w, 0x01));

    _mm_storel_epi64((__m128i *)(SrcPtr - inc2), _mm256_castsi256_si128(TLR1w));
    _mm_storel_epi64((__m128i *)(SrcPtr + inc),
                     _mm256_extracti128_si256(TLR1w, 0x01));

    _mm_storel_epi64((__m128i *)(SrcPtr - inc3), _mm256_castsi256_si128(TLR2));
    _mm_storel_epi64((__m128i *)(SrcPtr + inc2),
                     _mm256_extracti128_si256(TLR2, 0x01));
  } else {
    /* stroe result */
    TLR0w = _mm256_packus_epi16(TLR0w, c_0_256);
...
void deblock_edge_hor_c_avx2(pel_t *SrcPtrU, pel_t *SrcPtrV, int stride,
  ...
  TLR0 = _mm256_set_epi32(
      0, 0, ((int32_t *)(SrcPtrV))[0], ((int32_t *)(SrcPtrU))[0], 0, 0,
      ((int32_t *)(SrcPtrV - inc))[0], ((int32_t *)(SrcPtrU - inc))[0]);
  TLR1 = _mm256_set_epi32(
      0, 0, ((int32_t *)(SrcPtrV + inc))[0], ((int32_t *)(SrcPtrU + inc))[0], 0,
      0, ((int32_t *)(SrcPtrV - inc2))[0], ((int32_t *)(SrcPtrU - inc2))[0]);
  TLR2 = _mm256_set_epi32(
      0, 0, ((int32_t *)(SrcPtrV + inc2))[0], ((int32_t *)(SrcPtrU + inc2))[0],
      0, 0, ((int32_t *)(SrcPtrV - inc3))[0], ((int32_t *)(SrcPtrU - inc3))[0]);

  TLR0 = _mm256_unpacklo_epi8(TLR0, c_0_256);
  TLR1 = _mm256_unpacklo_epi8(TLR1, c_0_256);
  TLR2 = _mm256_unpacklo_epi8(TLR2, c_0_256);

  TRL0 = _mm256_inserti128_si256(
      _mm256_castsi128_si256(_mm256_extracti128_si256(TLR0, 0x01)),
      _mm256_castsi256_si128(TLR0), 1);
  TRL1 = _mm256_inserti128_si256(
      _mm256_castsi128_si256(_mm256_extracti128_si256(TLR1, 0x01)),
      _mm256_castsi256_si128(TLR1), 1);
