...
void deblock_edge_hor_c_sse128(pel_t *SrcPtrU, pel_t *SrcPtrV, int stride,
  ...
  TL0 = _mm_set_epi32(0, 0, ((int32_t *)(SrcPtrV - inc))[0],
                      ((int32_t *)(SrcPtrU - inc))[0]);
  TL1 = _mm_set_epi32(0, 0, ((int32_t *)(SrcPtrV - inc2))[0],
                      ((int32_t *)(SrcPtrU - inc2))[0]);
  TL2 = _mm_set_epi32(0, 0, ((int32_t *)(SrcPtrV - inc3))[0],
                      ((int32_t *)(SrcPtrU - inc3))[0]);
  TR0 =
      _mm_set_epi32(0, 0, ((int32_t *)(SrcPtrV))[0], ((int32_t *)(SrcPtrU))[0]);
  TR1 = _mm_set_epi32(0, 0, ((int32_t *)(SrcPtrV + inc))[0],
                      ((int32_t *)(SrcPtrU + inc))[0]);
  TR2 = _mm_set_epi32(0, 0, ((int32_t *)(SrcPtrV + inc2))[0],
                      ((int32_t *)(SrcPtrU + inc2))[0]);
