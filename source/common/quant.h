 ...
 */
static ALWAYS_INLINE int cu_get_chroma_qp(davs2_t *h, int luma_qp, int uv) {
  int qp = luma_qp + (uv == 0 ? h->chroma_quant_param_delta_u
                              : h->chroma_quant_param_delta_v);
 ...
 */
static ALWAYS_INLINE void cu_get_quant_params(davs2_t *h, int qp, int bit_size,
                                              int *shift, int *scale) {
